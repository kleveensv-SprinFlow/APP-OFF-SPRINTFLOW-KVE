...
import { ChevronLeft, LogOut, RefreshCw, Crown, User as UserIcon } from 'lucide-react';
...
export default function Header({ userRole, onRefreshData, onProfileClick, canGoBack, onBack, title }: HeaderProps) {
